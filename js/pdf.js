...
<style>
  ...
  * { box-sizing: border-box; }
  html, body { height: 100%; margin: 0; background: #f3f4f6; color: #111; font-family: "Open Sans", Arial, sans-serif; }
...
<body>
  ...
  function setCanvasFont(ctx, size, bold = false) {
    ctx.font = `${bold ? '700' : '400'} ${size}px "Open Sans", Arial, "Noto Sans Sinhala", "Iskoola Pota", sans-serif`;
    ctx.fillStyle = '#111';
  }
